...
public interface SurveyRepository extends JpaRepository<Survey, Integer> {
    ...
    @Query(value = "select * from survey left join question on survey.id_survey = question.id_survey where survey.url= :url", nativeQuery = true)
    public List<Survey> findbyurl(@Param(value = "url") String url);
