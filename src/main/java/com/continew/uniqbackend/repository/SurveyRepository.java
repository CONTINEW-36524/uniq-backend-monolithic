...
public interface SurveyRepository extends JpaRepository<Survey, Integer> {
    ...
    @Query(value = "select * from survey where writer = :user_id and survey.category = :category and survey.likenum > :like", nativeQuery = true)
    ...
    //내가 찜한 템플릿
    @Query(value = "select survey.* from survey left join fav_survey on survey.id_survey = fav_survey.id_survey where fav_survey.user_code = :user_id and survey.category = :category and survey.likenum > :like", nativeQuery = true)
